namespace MaquetteForAnaqsup.UI.Models.DTO
{
    ...
    {
        public virtual ImportDataDto? ImportData { get; set; }
        ...
        public bool? IsCommun { get; set; } = true;
        ...
        public List<DataParcourDto> ListParcours { get; set; } = new List<DataParcourDto>();
        public List<DataFormationDto> ListFormations { get; set; } = new List<DataFormationDto>();
        public List<DataDepartementDto> ListDepartements { get; set; } = new List<DataDepartementDto>();
