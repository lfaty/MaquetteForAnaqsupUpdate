...
namespace MaquetteForAnaqsup.API.Services
{
    public class DatasService : IDatasService
    {
        ...
        public async Task<IEnumerable<ImportData>> GetAllAsync()
        {
            ...
            return filteredData.Select(x => new ImportData
            {
                CodeUniversite = x.CodeUniversite,
                Departement = x.Departement,
                Abreviation = x.Abreviation,
                LibelleFormation = x.LibelleFormation,
                Grade = x.Grade,
                Parcours = x.Parcours,
                Niveau = x.Niveau,
                LibelleUE = x.LibelleUE,
                CreditUE = x.CreditUE,
                LibelleLongEC = x.LibelleLongEC,
                CoefEC = x.CoefEC,
                Semestre = x.Semestre,
                CM = x.CM,
                SEM = x.SEM,
